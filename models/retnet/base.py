...
from models.retnet.msr import MultiScaleRetention
    ...
    def forward(
        ...
        if activate_recurrent:
            ...
            if padding_mask is not None:
                mask = mask.unsqueeze(0).masked_fill(
                    padding_mask.unsqueeze(1).unsqueeze(-1), 0
                )
                mask = mask.masked_fill(padding_mask.unsqueeze(1).unsqueeze(2), 0)
