...
class MultiScaleRetention(nn.Module):
    ...
    def parallel_forward(self, qr, kr, v, mask=None, padding_mask=None):
        ...
        # recently fixed in https://github.com/microsoft/torchscale/commit/fdd8838a756c7c435d7f8a1e4303e150dfac7442
    ...
    def recurrent_forward(
        ...
        if padding_mask is not None:
            # scale = scale.masked_fill(padding_mask.unsqueeze(1), 0)
            kv[padding_mask, ...] = 0
    ...
    def chunk_recurrent_forward(self, qr, kr, v, padding_mask, inner_mask):
        # TODO set padding mask
    ...
    def forward(
        ...
        if incremental_state is not None:
            ...
            output = self.chunk_recurrent_forward(
                qr, kr, v, padding_mask=padding_mask, inner_mask=inner_mask
            )
        else:
            output = self.parallel_forward(
                qr, kr, v, padding_mask=padding_mask, mask=inner_mask
            )
