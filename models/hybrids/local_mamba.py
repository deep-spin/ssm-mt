...
from models.hybrids.helpers.local_attention import LocalAttentionWrapper
...
class HybridLocalMamba(pl.LightningModule):
    is_encoder_decoder = False
    is_concat = False  # FIXME remove
    model_name = "mamba_local"
    configs = {
        "default": {
            # mamba config
            "d_model": 624,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.decoder = MambaDecoder(
            ...
            layer_dict=dict((i, LocalAttentionWrapper) for i in self.layers),
    ...
    def test_step(self, batch, batch_idx):
        ...
        for idx in range(maxseq_len):
            ...
            attention_mask = input_ids.ne(self.tokenizer.pad_token_id).to(torch.bool)
