...
from models.hybrids.helpers.sliding_attention import SlidingAttentionWrapper
...
class HybridSlidingMamba(pl.LightningModule):
    is_encoder_decoder = False
    is_concat = False  # FIXME remove
    model_name = "mamba_sliding"
    configs = {
        "default": {
            # mamba config
            "d_model": 624,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.decoder = MambaDecoder(
            ...
            layer_dict=dict((i, SlidingAttentionWrapper) for i in self.layers),
